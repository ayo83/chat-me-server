...
import { followerService } from '@service/database/follower.service';
import mongoose from 'mongoose';
import { Helpers } from '@global/helpers/helpers';
import { IPostDocument } from '@post/interfaces/post.interface';
import { postService } from '@service/database/post.service';
...
export class Get {
  public async all(req: Request, res: Response): Promise<void> {
    ...
    res.status(HTTP_STATUS.OK).json({ message: 'Get users', totalUsers: allUsers.totalUsers, users: allUsers.users,  followers });
  }
